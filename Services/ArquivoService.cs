...
//        private readonly List<string> _allowedExtensions = new List<string> { ".pdf", ".docx", ".doc", ".png", ".jpg", ".jpeg", ".gif" };

//        private const long _maxFileSize = 10 * 1024 * 1024; // 5MB
...
//                CaminhoServidor = $"/uploads/{uniqueFileName}"
//            };
...
//            if (arquivo != null)
//            {
//                var filePath = Path.Combine(_environment.WebRootPath, arquivo.CaminhoServidor.TrimStart('/'));
...
namespace WebCurriculum.Services
{
    public class ArquivoService : IArquivoService
    {
        ...
        public async Task<Arquivo> SaveFileAsync(IFormFile file)
        {
            ...
            // Verifica se o WebRootPath é nulo e usa o ContentRootPath como alternativa
